...
// Date        : Fri Aug 28 17:04:04 2026
// Host        : prime-ThinkBook running 64-bit Ubuntu 26.04 LTS
// Command     : write_verilog -force /home/prime/Trojan_X/PS13_Hardware_Security/NETLISTS/clean/alu8_clean_netlist.v
// Design      : alu8_top
...
module trojan_alu8
  ...
  wire \LED_OBUF[15]_inst_i_14_n_0 ;
  wire \LED_OBUF[15]_inst_i_15_n_0 ;
  wire \LED_OBUF[15]_inst_i_2_n_0 ;
  wire \LED_OBUF[15]_inst_i_3_n_0 ;
  wire \LED_OBUF[15]_inst_i_4_n_0 ;
  wire \LED_OBUF[15]_inst_i_4_n_1 ;
  wire \LED_OBUF[15]_inst_i_4_n_2 ;
  wire \LED_OBUF[15]_inst_i_4_n_3 ;
  wire \LED_OBUF[15]_inst_i_4_n_5 ;
  wire \LED_OBUF[15]_inst_i_4_n_6 ;
  wire \LED_OBUF[15]_inst_i_4_n_7 ;
  wire \LED_OBUF[15]_inst_i_5_n_0 ;
  wire \LED_OBUF[15]_inst_i_6_n_0 ;
  wire \LED_OBUF[15]_inst_i_7_n_0 ;
  wire \LED_OBUF[15]_inst_i_7_n_1 ;
  wire \LED_OBUF[15]_inst_i_7_n_2 ;
  wire \LED_OBUF[15]_inst_i_7_n_3 ;
  wire \LED_OBUF[15]_inst_i_7_n_4 ;
  wire \LED_OBUF[15]_inst_i_7_n_5 ;
  wire \LED_OBUF[15]_inst_i_7_n_6 ;
  wire \LED_OBUF[15]_inst_i_7_n_7 ;
  ...
  LUT6 #(
    ...
    \LED_OBUF[13]_inst_i_1 
       (.I0(\LED_OBUF[13]_inst_i_2_n_0 ),
        ...
        .O(LED_OBUF[8]));
  LUT6 #(
    .INIT(64'h0000800000228000)) 
    \LED_OBUF[13]_inst_i_2 
       (.I0(BTNL_IBUF),
        .I1(SW_IBUF[6]),
        .I2(\LED_OBUF[15]_inst_i_5_n_0 ),
        .I3(SW_IBUF[7]),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_6_n_0 ),
        .O(\LED_OBUF[13]_inst_i_2_n_0 ));
  CARRY4 \LED_OBUF[13]_inst_i_3 
       (.CI(\LED_OBUF[15]_inst_i_4_n_0 ),
        .CO(data0),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  LUT2 #(
    .INIT(4'h6)) 
    \LED_OBUF[15]_inst_i_14 
       (.I0(SW_IBUF[1]),
        .I1(SW_IBUF[9]),
        .O(\LED_OBUF[15]_inst_i_14_n_0 ));
  LUT2 #(
    .INIT(4'h6)) 
    \LED_OBUF[15]_inst_i_15 
       (.I0(SW_IBUF[0]),
        .I1(SW_IBUF[8]),
        .O(\LED_OBUF[15]_inst_i_15_n_0 ));
  LUT6 #(
    .INIT(64'h0000000044182218)) 
    \LED_OBUF[15]_inst_i_2 
       (.I0(SW_IBUF[7]),
        .I1(SW_IBUF[15]),
        .I2(p_1_in2_in),
        .I3(BTNR_IBUF),
        .I4(\alu_y0_inferred__5/i__carry__0_n_4 ),
        .I5(BTNL_IBUF),
  ...
  CARRY4 \LED_OBUF[15]_inst_i_4 
       (.CI(\LED_OBUF[15]_inst_i_7_n_0 ),
        .CO({\LED_OBUF[15]_inst_i_4_n_0 ,\LED_OBUF[15]_inst_i_4_n_1 ,\LED_OBUF[15]_inst_i_4_n_2 ,\LED_OBUF[15]_inst_i_4_n_3 }),
        .CYINIT(\<const0> ),
        .DI(SW_IBUF[7:4]),
        .O({p_1_in2_in,\LED_OBUF[15]_inst_i_4_n_5 ,\LED_OBUF[15]_inst_i_4_n_6 ,\LED_OBUF[15]_inst_i_4_n_7 }),
        .S({\LED_OBUF[15]_inst_i_8_n_0 ,\LED_OBUF[15]_inst_i_9_n_0 ,\LED_OBUF[15]_inst_i_10_n_0 ,\LED_OBUF[15]_inst_i_11_n_0 }));
  LUT6 #(
  ...
  CARRY4 \LED_OBUF[15]_inst_i_7 
       (.CI(\<const0> ),
        .CO({\LED_OBUF[15]_inst_i_7_n_0 ,\LED_OBUF[15]_inst_i_7_n_1 ,\LED_OBUF[15]_inst_i_7_n_2 ,\LED_OBUF[15]_inst_i_7_n_3 }),
        .CYINIT(\<const0> ),
        .DI(SW_IBUF[3:0]),
        .O({\LED_OBUF[15]_inst_i_7_n_4 ,\LED_OBUF[15]_inst_i_7_n_5 ,\LED_OBUF[15]_inst_i_7_n_6 ,\LED_OBUF[15]_inst_i_7_n_7 }),
        .S({\LED_OBUF[15]_inst_i_12_n_0 ,\LED_OBUF[15]_inst_i_13_n_0 ,\LED_OBUF[15]_inst_i_14_n_0 ,\LED_OBUF[15]_inst_i_15_n_0 }));
  LUT2 #(
    .INIT(4'h6)) 
  ...
  LUT6 #(
    ...
    \LED_OBUF[4]_inst_i_3 
       (.I0(SW_IBUF[0]),
        .I1(SW_IBUF[8]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry_n_7 ),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_7_n_7 ),
  ...
  LUT6 #(
    ...
    \LED_OBUF[5]_inst_i_4 
       (.I0(SW_IBUF[4]),
        .I1(SW_IBUF[12]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry__0_n_7 ),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_4_n_7 ),
        .O(\LED_OBUF[5]_inst_i_4_n_0 ));
  LUT5 #(
    .INIT(32'h888BBBB8)) 
    \LED_OBUF[5]_inst_i_5 
       (.I0(\LED_OBUF[5]_inst_i_8_n_0 ),
        .I1(BTNL_IBUF),
        .I2(BTNR_IBUF),
        .I3(SW_IBUF[12]),
        .I4(SW_IBUF[4]),
  ...
  LUT6 #(
    ...
    \LED_OBUF[5]_inst_i_6 
       (.I0(SW_IBUF[1]),
        .I1(SW_IBUF[9]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry_n_6 ),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_7_n_6 ),
  ...
  LUT6 #(
    ...
    \LED_OBUF[6]_inst_i_4 
       (.I0(SW_IBUF[5]),
        .I1(SW_IBUF[13]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry__0_n_6 ),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_4_n_6 ),
        .O(\LED_OBUF[6]_inst_i_4_n_0 ));
  LUT6 #(
    .INIT(64'hA030A03F5FCF5FC0)) 
    \LED_OBUF[6]_inst_i_5 
       (.I0(\LED_OBUF[6]_inst_i_8_n_0 ),
  ...
  LUT6 #(
    ...
    \LED_OBUF[6]_inst_i_6 
       (.I0(SW_IBUF[2]),
        .I1(SW_IBUF[10]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry_n_5 ),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_7_n_5 ),
        .O(\LED_OBUF[6]_inst_i_6_n_0 ));
  LUT6 #(
    .INIT(64'hE070E07F1F8F1F80)) 
  ...
  LUT6 #(
    ...
    \LED_OBUF[7]_inst_i_1 
       (.I0(alu_y__54[6]),
        ...
        .O(LED_OBUF[7]));
  LUT6 #(
    .INIT(64'h50C050CF5FCF5FC0)) 
    \LED_OBUF[7]_inst_i_10 
       (.I0(\LED_OBUF[7]_inst_i_12_n_0 ),
        .I1(\LED_OBUF[7]_inst_i_13_n_0 ),
        .I2(BTNL_IBUF),
        .I3(BTNR_IBUF),
        .I4(SW_IBUF[15]),
        .I5(SW_IBUF[7]),
  ...
  MUXF7 \LED_OBUF[7]_inst_i_3 
       (.I0(\LED_OBUF[7]_inst_i_7_n_0 ),
        .I1(\LED_OBUF[7]_inst_i_8_n_0 ),
        .O(alu_y__54[3]),
        .S(BTNU_IBUF));
  MUXF7 \LED_OBUF[7]_inst_i_4 
       (.I0(\LED_OBUF[7]_inst_i_9_n_0 ),
        .I1(\LED_OBUF[7]_inst_i_10_n_0 ),
        .O(alu_y__54[7]),
        .S(BTNU_IBUF));
  LUT6 #(
    .INIT(64'hEFE08F8FEFE08080)) 
    \LED_OBUF[7]_inst_i_5 
       (.I0(SW_IBUF[6]),
        .I1(SW_IBUF[14]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry__0_n_5 ),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_4_n_5 ),
        .O(\LED_OBUF[7]_inst_i_5_n_0 ));
  LUT6 #(
    .INIT(64'hA030A03F5FCF5FC0)) 
    \LED_OBUF[7]_inst_i_6 
       (.I0(\LED_OBUF[15]_inst_i_6_n_0 ),
  ...
  LUT6 #(
    ...
    \LED_OBUF[7]_inst_i_7 
       (.I0(SW_IBUF[3]),
        .I1(SW_IBUF[11]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry_n_4 ),
        .I4(BTNR_IBUF),
        .I5(\LED_OBUF[15]_inst_i_7_n_4 ),
  ...
  LUT6 #(
    ...
    \LED_OBUF[7]_inst_i_9 
       (.I0(SW_IBUF[7]),
        .I1(SW_IBUF[15]),
        .I2(BTNL_IBUF),
        .I3(\alu_y0_inferred__5/i__carry__0_n_4 ),
        .I4(BTNR_IBUF),
        .I5(p_1_in2_in),
  ...
  CARRY4 \alu_y0_inferred__5/i__carry__1 
  ...
  LUT4 #(
    ...
    \history[3]_i_1 
       (.I0(btnc_reg),
        ...
        .I2(btnd_reg),
        .I3(BTND_IBUF),
        .O(\history[3]_i_1_n_0 ));
  FDCE #(
    .INIT(1'b0)) 
    \history_reg[0] 
       (.C(CLK100MHZ_IBUF_BUFG),
        .CE(\history[3]_i_1_n_0 ),
        .CLR(CPU_RESETN),
        .D(btnc_edge),
        .Q(history[0]));
  FDCE #(
